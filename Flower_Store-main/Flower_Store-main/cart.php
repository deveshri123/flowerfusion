...
<section class="shopping-cart">
    ...
    <div  class="box">
        ...
        <div class="price"><?php echo $fetch_cart['price']; ?>Rs/-</div>
        ...
        <div class="sub-total"> sub-total : <span><?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>Rs/-</span> </div>
    </div>
    <?php
    ...
    <div class="cart-total">
        <p>grand total : <span><?php echo $grand_total; ?>Rs/-</span></p>
